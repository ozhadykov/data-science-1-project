...
With new 'room_count' feature, linear model performs the same: 797.381 - RMSE
On the other side tree model with a brand new feature has improved it's benchmark for 1.1%.
