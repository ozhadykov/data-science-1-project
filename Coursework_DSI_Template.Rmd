...
price_lm_2 <- lm(formula = price ~ area + bedrooms + hotwaterheating + airconditioning + stories + mainroad + parking + furnishingstatus + guestroom + basement + prefarea + count_bathrooms_1 + count_bathrooms_2 + count_bathrooms_3 + count_bathrooms_4 + area_log, data = dt_houses)
...
price_lm_2 <- lm(formula = price ~ + area + bedrooms + hotwaterheating + stories + mainroad + parking + furnishingstatus + guestroom + basement + prefarea + count_bathrooms_1 + count_bathrooms_2 + count_bathrooms_3 + count_bathrooms_4 + area_log + airconditioning_yes + airconditioning_no, data = dt_houses)
