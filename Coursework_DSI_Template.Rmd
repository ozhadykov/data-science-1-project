...
```{r}
ggplot() + 
  geom_point(data = dt_houses, aes(x = area, y = price), color='#000') +
...
I think that would be enough eploration and we can start with our first model.
...
I consider to take this variables in my model: area, bedrooms, hotwaterheating, stories, mainroad, parking
